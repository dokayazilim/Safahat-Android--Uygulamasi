...
public class giris extends ListActivity{
    String stringarray[]={"Fatih Camii","Hasta","Tevhid Yahut Feryad","Küfe","Durmayalým","Hasýr","Geçinme Belasý","Meyhane","Mezarlýk","Bayram","Hasbihal","Selma","Merhum Ýbrahim Bey","Azim","Seyfi Baba","Ýnsan","Kör Neyzen","Acem Þahý","Ýstibdat","Hürriyet","Kocakarý Ýle Ömer","Ezanlar","Canan Yurdu","Bir Mersiye","Dirvas","Mahalle Kahvesi","Köse Ýmam","Kýsa Þiirler","Ahiret Yolu","Ýstiðrak","Amin Alayý","Hasbihal","Bebek Yahut Hakk-ý Karar","Yemiþçi Ýhtiyar"};
	@Override
